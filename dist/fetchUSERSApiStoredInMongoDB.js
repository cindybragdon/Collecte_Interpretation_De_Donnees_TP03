...
const fetchUSERSApiStoredInMongoDB = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        console.log("Fetch Mongo Users : Démarrage du fetch des utilisateurs depuis l'API Fake Store.");
        const response = yield (0, node_fetch_1.default)("https://fakestoreapi.com/users");
        if (!response.ok) {
        ...
        if (validUsers.length > 0) {
            yield userMongo_model_1.default.deleteMany({}); // Vider la collection MongoDB
            console.log("Fetch Mongo Users : Collection MongoDB vidée.");
            yield userMongo_model_1.default.insertMany(validUsers)
                .then((result) => {
