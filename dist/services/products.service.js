...
class ProductsService {
    ...
    static async getAllProducts(minPrice = 0, maxPrice = 10000000000000, minInStock = 0, maxInStock = 10000000000000) {
    ...
    static async getProductsFiltered(minPrice, maxPrice, minInStock, maxInStock) {
    ...
    //*********************POST NEW PRODUCT*******************//
    static async addNewProduct(newProduct) {
    ...
    static async updateProduct(id, updatesPost) {
        //const filePath = path.join(__dirname, "data/productData.json");
    ...
    static async deleteProductById(idBody, deleteThis) {
        //const filePath = path.join(__dirname, "data/productData.json");
        // Lire le fichier JSON existant
        const productsList = Array.from(JSON.parse(fs.readFileSync("data/productData.json", {
            encoding: "utf8",
